...
$pdf->Cell(0, 10, 'Yearly Sales Report', 0, 1, 'C');
$pdf->Ln(10);
...
$rows = select("SELECT Name, AmountPaid, StartDate, EndDate FROM Clients WHERE YEAR(StartDate) = YEAR(CURDATE()) AND IsDelete = 1");
foreach ($rows as $row) {
