...
$Id = $_POST["Id"];
$membership = selectOne("SELECT * FROM Membership WHERE Id = $Id");
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Name" name="Name" placeholder="Enter Client Name" value="<?= $membership['Name'] ?>">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="Mobile" name="Mobile" placeholder="Enter Mobile Number Of The Client"  value="<?= $membership['Mobile'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="formrow-password-input" class="form-label">Address</label>
                                                    <input type="text" class="form-control" id="Address" name="Address" placeholder="Enter Client Address"  value="<?= $membership['Address'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="Age" name="Age" placeholder="Enter Age Of The Client"  value="<?= $membership['Age'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="formrow-password-input" class="form-label">Email</label>
                                                    <input type="email" class="form-control" id="Email" name="Email" placeholder="Enter Client's Email"   value="<?= $membership['Email'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="StartDate" name="StartDate" placeholder="Enter Service Start Date" value="<?= $membership['StartDate'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="formrow-password-input" class="form-label">Service End Date</label>
                                                    <input type="date" class="form-control" id="EndDate" name="EndDate" placeholder="Enter Service End Date"  value="<?= $membership['EndDate'] ?>">
