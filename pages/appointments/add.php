    ...
    <div id="layout-wrapper">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="AppointmentDate" name="AppointmentDate" placeholder="Enter Appointment Date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="time" class="form-control" id="AppointmentTime" name="AppointmentTime" placeholder="Enter Appointment Time">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
        ...
        <script>
            function insertData() {
                ...
                $.ajax({
                    url: '../../api/appointment/insert.php',
                    type: 'POST',
                    data: {
                        ClientId: ClientId,
